...
def main():
    ...
    with open("aider_lyra/__init__.py", "r") as f:
        content = f.read()
    ...
    print("Updating aider_lyra/__init__.py with new version:")
    print(updated_content)
    if not dry_run:
        with open("aider_lyra/__init__.py", "w") as f:
            f.write(updated_content)

    git_commands = [
        ["git", "add", "aider_lyra/__init__.py"],
    ...
    print()
    print("Updating aider_lyra/__init__.py with new dev version:")
