...
from aider_lyra import __version__
from aider_lyra.args_formatter import (
    DotEnvFormatter,
...
def get_parser(default_config_files, git_root):
    parser = configargparse.ArgumentParser(
        description="aider_lyra is GPT powered coding in your terminal",
        add_config_file_help=True,
        default_config_files=default_config_files,
        auto_env_var_prefix="aider_lyra_",
    )
    ...
    group.add_argument(
        ...
        help="Specify a file with aider_lyra model settings for unknown models",
    )
    group.add_argument(
        "--model-metadata-file",
    ...
    default_input_history_file = (
        os.path.join(git_root, ".aider_lyra.input.history") if git_root else ".aider_lyra.input.history"
    )
    default_chat_history_file = (
        os.path.join(git_root, ".aider_lyra.chat.history.md") if git_root else ".aider_lyra.chat.history.md"
    )
    group.add_argument(
        "--input-history-file",
    ...
    group.add_argument(
        ...
        default=None,
        help="Log the conversation with the LLM to this file (for example, .aider_lyra.llm.history)",
    )
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable/disable adding .aider_lyra* to .gitignore (default: True)",
    )
    default_aider_lyraignore_file = (
        os.path.join(git_root, ".aider_lyraignore") if git_root else ".aider_lyraignore"
    )
    group.add_argument(
        "--aider_lyraignore",
        metavar="aider_lyraIGNORE",
        default=default_aider_lyraignore_file,
        help="Specify the aider_lyra ignore file (default: .aider_lyraignore in git root)",
    )
    group.add_argument(
        "--subtree-only",
        action="store_true",
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute aider_lyra code changes in the git author name (default: True)",
    )
    group.add_argument(
        "--attribute-committer",
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute aider_lyra commits in the git committer name (default: True)",
    )
    group.add_argument(
        "--attribute-commit-message-author",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix commit messages with 'aider_lyra: ' if aider_lyra authored the changes (default: False)",
    )
    group.add_argument(
        "--attribute-commit-message-committer",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix all commit messages with 'aider_lyra: ' (default: False)",
    )
    group.add_argument(
        "--commit",
        action="store_true",
    ...
    group.add_argument(
        "--check-update",
        action=argparse.BooleanOptionalAction,
        help="Check for new aider_lyra versions on launch",
        default=True,
    )
    group.add_argument(
        "--apply",
    ...
    group.add_argument(
        ...
        metavar="CONFIG_FILE",
        help=(
            "Specify the config file (default: search for .aider_lyra.conf.yml in git root, cwd"
            " or home directory)"
        ),
    )
    group.add_argument(
        ...
        "--browser",
        action="store_true",
        help="Run aider_lyra in your browser",
        default=False,
    )
