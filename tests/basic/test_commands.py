...
from aider_lyra.utils import ChdirTemporaryDirectory, GitTemporaryDirectory, make_repo
...
class TestCommands(TestCase):
    ...
    def test_cmd_add_bad_glob(self):
        # https://github.com/paul-gauthier/aider_lyra/issues/293
    ...
    def test_cmd_add_from_subdir_again(self):
        with GitTemporaryDirectory():
            ...
            # https://github.com/paul-gauthier/aider_lyra/issues/201
    ...
    def test_cmd_add_from_outside_root(self):
        with ChdirTemporaryDirectory() as tmp_dname:
            ...
            # https://github.com/paul-gauthier/aider_lyra/issues/178
    ...
    def test_cmd_undo_with_dirty_files_not_in_last_commit(self):
        with GitTemporaryDirectory() as repo_dir:
            ...
            coder.aider_lyra_commit_hashes.add(last_commit_hash)
    ...
    def test_cmd_add_aider_lyraignored_file(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
            ...
            repo = GitRepo(
                ...
                fnames,
                None,
                aider_lyra_ignore_file=str(aignore),
            )
    ...
    def test_cmd_ask(self):
        ...
        with mock.patch("aider_lyra.coders.Coder.run") as mock_run:
