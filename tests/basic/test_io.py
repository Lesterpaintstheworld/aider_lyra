...
from aider_lyra.io import AutoCompleter, InputOutput
from aider_lyra.utils import ChdirTemporaryDirectory
...
class TestInputOutput(unittest.TestCase):
    ...
    @patch("aider_lyra.io.PromptSession")
    def test_get_input_is_a_directory_error(self, MockPromptSession):
        ...
        with patch("aider_lyra.io.open", side_effect=IsADirectoryError):
