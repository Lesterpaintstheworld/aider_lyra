...
from aider_lyra import __version__, urls, utils
from aider_lyra.dump import dump  # noqa: F401

aider_lyra_user_agent = f"aider_lyra/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["aider_lyra-chat[playwright]"])
...
class Scraper:
    ...
    def scrape_with_playwright(self, url):
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                user_agent = user_agent.replace("headless", "")
                user_agent += " " + aider_lyra_user_agent
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({aider_lyra_user_agent})"}
        try:
