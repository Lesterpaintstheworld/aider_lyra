...
import os
from aider_lyra import __version__, models, utils
from aider_lyra.file_selector import select_relevant_files
from aider_lyra.args import get_parser
from aider_lyra.coders import Coder
from aider_lyra.commands import Commands, SwitchCoder
...
def check_streamlit_install(io):
    return utils.check_pip_install_extra(
        io,
        "streamlit",
        "You need to install the aider_lyra browser feature",
...
def register_models(git_root, model_settings_fname, io, verbose=False):
    model_settings_files = generate_search_path_list(
        ".aider_lyra.model.settings.yml", git_root, model_settings_fname
    )
    ...
    try:
        ...
        io.tool_error(f"Error loading aider_lyra model settings: {e}")
        return 1
...
def register_litellm_models(git_root, model_metadata_fname, io, verbose=False):
    model_metatdata_files = generate_search_path_list(
        ".aider_lyra.model.metadata.json", git_root, model_metadata_fname
    )
...
def main(argv=None, input=None, output=None, force_git_root=None, return_coder=False):
    ...
    conf_fname = Path(".aider_lyra.conf.yml")
    ...
    io.tool_output('Use /help <question> for help, run "aider_lyra --help" to see cmd line args')
