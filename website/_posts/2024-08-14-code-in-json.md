...
> Figure 1: aider_lyra coding benchmark scores of models using either plain markdown text or JSON to return code.
...
People often ask why aider_lyra uses a plain text format for LLMs to specify code edits (below),
...
Previous [aider_lyra benchmark results](/2023/07/02/benchmarks.html)
showed
...
the 
[aider_lyra "code editing" benchmark](/2023/07/02/benchmarks.html#the-benchmark)
...
aider_lyra's "whole" edit format, where the
...
#### Notes on the aider_lyra leaderboard

*The results presented here are not directly comparable to results
from the main
[aider_lyra LLM leaderboard](https://aider_lyra.chat/docs/leaderboards/).
