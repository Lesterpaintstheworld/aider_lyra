...
# aider_lyra LLM Leaderboards
{: .no_toc }

aider_lyra works best with LLMs which are good at *editing* code, not just good at writing
code.
To evaluate an LLM's editing skill, aider_lyra uses a pair of benchmarks that
...
While [aider_lyra can connect to almost any LLM](/docs/llms.html),
...
[aider_lyra's code editing benchmark](/docs/benchmarks.html#the-benchmark) asks the LLM to edit python source files to complete 133 small coding exercises
from Exercism. 
...
[aider_lyra's refactoring benchmark](https://github.com/paul-gauthier/refactor-benchmark) asks the LLM to refactor 89 large methods from large python classes. This is a more challenging benchmark, which tests the model's ability to output long chunks of code without skipping sections or making mistakes. It was developed to provoke and measure [GPT-4 Turbo's "lazy coding" habit](/2023/12/21/unified-diffs.html).
...
[![connecting to many LLMs](/assets/models-over-time.svg)](https://aider_lyra.chat/assets/models-over-time.svg)
...
- **Percent using correct edit format** - Measures the percent of coding tasks where the LLM complied with the edit format specified in the system prompt. If the LLM makes edit mistakes, aider_lyra will give it feedback and ask for a fixed copy of the edit. The best models can reliably conform to the edit format, without making errors.
...
See the
[benchmark README](https://github.com/paul-gauthier/aider_lyra/blob/main/benchmark/README.md)
for information on running aider_lyra's code editing benchmarks.
Submit results by opening a PR with edits to the
[benchmark results data files](https://github.com/paul-gauthier/aider_lyra/blob/main/website/_data/).
...
files = [
    ...
    'aider_lyra/website/_data/edit_leaderboard.yml',
    'aider_lyra/website/_data/refactor_leaderboard.yml'
]
