...
excerpt: This report provides a detailed comparison of the speed of GPT-4 Turbo and gpt-3.5-turbo-1106 models based on the aider_lyra benchmarking suite.
canonical_url: https://aider_lyra.chat/2023/11/06/benchmarks-speed-1106.html
...
reports to get more background on aider_lyra's benchmark suite:
...
- [Code editing skill benchmarks for OpenAI's "1106" models](https://aider_lyra.chat/docs/benchmarks-1106.html) compares the olders models to the November (1106) models.

## Speed

This report compares the **speed** of the various GPT models.
aider_lyra's benchmark measures the response time of the OpenAI chat completion
