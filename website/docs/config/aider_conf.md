...
nav_order: 15
description: How to configure aider_lyra with a yaml config file.
---

# YAML config file

Most of aider_lyra's options can be set in an `.aider_lyra.conf.yml` file.
aider_lyra will look for a this file in these locations and
...
can also
[download from GitHub](https://github.com/paul-gauthier/aider_lyra/blob/main/aider_lyra/website/assets/sample.aider_lyra.conf.yml).

<!--[[[cog
from aider_lyra.args import get_sample_yaml
from pathlib import Path
text=get_sample_yaml()
Path("aider_lyra/website/assets/sample.aider_lyra.conf.yml").write_text(text)
cog.outl("```")
cog.out(text)
cog.outl("```")
]]]-->
...
#model-settings-file: .aider_lyra.model.settings.yml

## Specify a file with context window and costs for unknown models
#model-metadata-file: .aider_lyra.model.metadata.json
...
#input-history-file: .aider_lyra.input.history

## Specify the chat history file (default: .aider_lyra.chat.history.md)
#chat-history-file: .aider_lyra.chat.history.md
