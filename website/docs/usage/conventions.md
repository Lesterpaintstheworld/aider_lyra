...
parent: Usage
nav_order: 800
description: Tell aider_lyra to follow your coding conventions when it works on your code.
---
...
The easiest way to do that with aider_lyra is to simply create
...
and then we can add it to the aider_lyra chat, along with the file(s)
that we want to edit:

<div class="chat-transcript" markdown="1">
> $ aider_lyra CONVENTIONS.md useragent.py  
>  
> aider_lyra v0.24.2-dev  
